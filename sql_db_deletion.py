from databases.sql_database import delete_sql_database
# runner file
...
database_name=get_parameter("C:\\Users\\Public\\azure_sdk_temp\\azure_sdk\\parameter.dev",'sql_database_name')
subscription_id=get_parameter("C:\\Users\\Public\\azure_sdk_temp\\azure_sdk\\parameter.dev",'subscription_id')


delete_sql_database(subscription_id,resource_group_name,server_name,database_name)
