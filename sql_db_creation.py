from databases.sql_database import create_sql_database
# runner file
...
server_name=get_parameter("C:\\Users\\Public\\azure_sdk_temp\\azure_sdk\\parameter.dev",'sql_server_name')
administrator_login=get_parameter("C:\\Users\\Public\\azure_sdk_temp\\azure_sdk\\parameter.dev",'sql_administrator_login')
administrator_login_password=get_parameter("C:\\Users\\Public\\azure_sdk_temp\\azure_sdk\\parameter.dev",'sql_administrator_login_password')

create_sql_database(subscription_id,resource_group_name,location,server_name,administrator_login,administrator_login_password)